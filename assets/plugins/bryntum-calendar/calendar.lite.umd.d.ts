/*!
 *
 * Bryntum Calendar 4.1.6 (TRIAL VERSION)
 *
...
declare module '@bryntum/calendar/calendar.lite.umd.js' {
    ...
    export class CalendarStores extends ProjectConsumer {
        ...
        resources: ResourceModel[]|object[]|Partial<ResourceModelConfig>[]
        onBeforeEventDelete: Function
        constructor(config?: Partial<CalendarStoresConfig>);
    }
    ...
    type CalendarConfig = {
        ...
        crudManager: object|AbstractCrudManagerMixin|Partial<AbstractCrudManagerMixinConfig>
    ...
    export class Calendar extends Panel implements CalendarStores, CrudManagerView, EventNavigation, EventSelection {
    ...
    export class EventNavigation extends SchedulerEventNavigation {
        activeEvent: EventModel
    ...
    export class EventSelection extends SchedulerEventSelection {
        selectedEvents: EventModel[]
        onSelectionChange: Function
    ...
    export class AgendaView extends EventList implements DayCellCollecter {
        onRefresh: Function
    ...
    export class CalendarRow extends Widget implements DayCellRenderer, CalendarMixin {
        dayCellCls: string
        ...
        getEventElements(event: EventModel): HTMLElement[];
        getEventRecord(elementOrEvent: HTMLElement|Event): EventModel;
    ...
    export class DayView extends Panel implements CalendarMixin, DayCellCollecter {
        dayCellCls: string
        dayEndTime: string|number
        dayStartTime: string|number
    ...
    export class EventList extends Grid implements CalendarStores {
        date: Date
        defaultCalendar: ResourceModel
        endDate: Date
        eventStore: EventStore
    ...
    export class MonthView extends CalendarPanel implements DayCellCollecter, DayCellRenderer, CalendarMixin {
        dayCellCls: string
        visibleCellSelector: string
        onWeekFlex: Function
        onWeekShrinkwrap: Function
        ...
        resolveEventRecord(elementOrEvent: HTMLElement|Event): EventModel;
        scrollTo(target: EventModel|Date, options?: object): Promise<any>;
        shrinkwrapWeekRow(date: Date|number): void;
    }
    ...
    export class YearView extends Panel implements CalendarMixin, DayCellCollecter, DayCellRenderer {
        dayCellCls: string
        visibleCellSelector: string
        onRefresh: Function
    ...
    export class CalendarMixin {
        dayCellCls: string
        visibleCellSelector: string
        constructor(config?: Partial<CalendarMixinConfig>);
        calendarHitTest(domEvent: Event|Element): CalendarHit;
        createEvent(date: Date): void;
        getDayElement(date: Date|string, strict: boolean): void;
        getEventElement(eventRecord: EventModel|string|number, date?: Date): HTMLElement;
    ...
    type DayCellCollecterConfig = {
        eventFilter: Function
    }

    export class DayCellCollecter {
        constructor(config?: Partial<DayCellCollecterConfig>);
    }

    type DayCellRendererConfig = {
        dayCellRenderer: Function
        overflowPopupTrigger: string
    }

    export class DayCellRenderer {
        constructor(config?: Partial<DayCellRendererConfig>);
    }
    ...
    export class EventContextMenu extends SchedulerEventMenu {
    ...
    export class SchedulerEventEdit extends EditBase implements RecurringEventEdit {
        cancelButton: Button
        deleteButton: Button
        editRecurrenceButton: RecurrenceLegendButton
    ...
    export class ScheduleContextMenu extends SchedulerScheduleMenu {
    ...
    export class SchedulerBase extends TimelineBase implements SchedulerEventNavigation, SchedulerEventSelection, SchedulerDom, SchedulerDomEvents, SchedulerEventRendering, SchedulerRegions, SchedulerScroll, SchedulerState, SchedulerStores, TimelineDateMapper, TimelineDomEvents, TimelineEventRendering, TimelineScroll, TimelineViewPresets, TimelineZoomable, CrudManagerView, ProjectConsumer {
    ...
    type SchedulerEventNavigationConfig = {
        enableDeleteKey: boolean
        onBeforeAssignmentDelete: Function
        onBeforeEventDelete: Function
        onNavigate: Function
    ...
    export class SchedulerEventNavigation {
        onBeforeAssignmentDelete: Function
        onBeforeEventDelete: Function
        onNavigate: Function
        constructor(config?: Partial<SchedulerEventNavigationConfig>);
    }

    type SchedulerEventSelectionConfig = {
        eventSelectionDisabled: boolean
        highlightPredecessors: boolean
        highlightSuccessors: boolean
        maintainSelectionOnDatasetChange: boolean
    ...
    export class SchedulerEventSelection {
        selectedAssignments: AssignmentModel[]
        selectedEvents: EventModel[]
        onAssignmentSelectionChange: Function
        onEventSelectionChange: Function
        constructor(config?: Partial<SchedulerEventSelectionConfig>);
        clearEventSelection(): void;
        deselect(eventOrAssignment: EventModel|AssignmentModel): void;
        deselectAssignment(assignment: AssignmentModel): void;
        deselectAssignments(assignments: AssignmentModel[]): void;
