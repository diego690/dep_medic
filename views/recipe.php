                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-9">
                                                ...
                                                <div class="mb-3 form-group" id="container_product_2" style="display: none;">
                                                    <label for="txt_product" class="form-label">Producto <span style="color: red;">*</span></label>
                                                    <input type="text" class="form-control" id="txt_product" name="txt_product" maxlength="150">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
        ...
        $(document).ready(function() {
            ...
            $("#btn_add").on("click", function() {
                let details = {
                    ...
                    product: ($("#select_product_type").val() == "1") ? $("#select_product option:selected").text() : $.trim($("#txt_product").val()),
                    productID: ($("#select_product_type").val() == "1") ? $("#select_product").val() : $.trim($("#txt_product").val()),
