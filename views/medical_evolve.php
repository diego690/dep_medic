...
?>
        <form id="responseForm" action="/<?= BASE_URL ?>patient-attention/<?= urlencode(strrev(base64_encode($patientID))) ?>" method="post">
            ...
            <input type="hidden" name="response_msg" value="Se ha registrado exitosamente la evolución del paciente.">
        </form>
...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Evolución</title>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="create_form" action="" method="post" novalidate="novalidate">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label for="txt_evolve_notes" class="form-label">Notas de Evolución <span style="color: red;">*</span></label>
                                            <input type="text" class="form-control" id="txt_evolve_notes" name="txt_evolve_notes" maxlength="150">
                                        </div>
                                        <div class="mb-3 form-group">
                                            <label for="txt_prescription" class="form-label">Prescripción <span style="color: red;">*</span></label>
                                            <input type="text" class="form-control" id="txt_prescription" name="txt_prescription" maxlength="90">
                                        </div>
