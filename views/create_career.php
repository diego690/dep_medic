...
if ($is_post) {
    ...
    if (!$adminFunctions->existsCareer(trim($_POST["txt_name"]))) {
        $isCreated = false;
        $result = $adminFunctions->createCareer(base64_decode(strrev(urldecode($_POST["select_faculty"]))), trim($_POST["txt_name"]), trim($_POST["txt_description"]));
        if ($result > 0) {
            $isCreated = true;
        }

        if ($isCreated) {
            array_push($msg_response["success"], "La carrera ha sido registrada exitosamente.");
        } else {
            array_push($msg_response["errors"], "La carrera no ha podido ser registrada.");
        }
    } else {
...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Registrar Carrera</title>
...
<body data-theme="colored" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="<?= SIDEBAR_TYPE ?>">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Registrar Carrera</h1>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="create_form" action="create-career" method="post" novalidate="novalidate">
                                        ...
                                        <div class="mb-3 form-group">
                                            ...
                                            <select class="form-control" id="select_faculty" name="select_faculty" style="width: 100%;">
                                                ...
                                                ?>
                                                    <option value="<?= urlencode(strrev(base64_encode($row->id))) ?>"><?= $row->name ?></option>
                                                <?php
                                                }
                                                ?>
                                            </select>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#mnu_careers_create").addClass("active");
