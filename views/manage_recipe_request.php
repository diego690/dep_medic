...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Mis Recetas</title>
...
<body data-theme="colored" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="<?= SIDEBAR_TYPE ?>">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Mis Recetas</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Listado de mis recetas</h5>
                                </div>
                                <div class="card-body">
                                    <table id="tb_recipe" class="table table-striped table-hover table-bordered table-sm">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var tb_recipe = $('#tb_recipe');
            dt_recipe = tb_recipe.DataTable(tbOptions);
        });
    </script>
