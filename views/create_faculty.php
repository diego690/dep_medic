...
if ($is_post) {
    ...
    if (!$adminFunctions->existsFaculty(trim($_POST["txt_name"]))) {
        $isCreated = false;
        $result = $adminFunctions->createFaculty(trim($_POST["txt_name"]), trim($_POST["txt_description"]));
        if ($result > 0) {
            $isCreated = true;
        }

        if ($isCreated) {
            array_push($msg_response["success"], "La facultad ha sido registrada exitosamente.");
        } else {
            array_push($msg_response["errors"], "La facultad no ha podido ser registrada.");
        }
    } else {
...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Registrar Facultad</title>
...
<body data-theme="colored" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="<?= SIDEBAR_TYPE ?>">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Registrar Facultad</h1>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form id="create_form" action="create-faculty" method="post" novalidate="novalidate">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#mnu_faculties_create").addClass("active");
