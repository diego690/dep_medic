...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Ver Empleados</title>
...
<body data-theme="colored" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="<?= SIDEBAR_TYPE ?>">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ver Empleados</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Listado de los empleados</h5>
                                </div>
                                <div class="card-body">
                                    <table id="tb_employees" class="table table-striped table-hover table-bordered table-sm">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#mnu_accounts_employees_manage").addClass("active");
            ...
            var tb_employees = $('#tb_employees');
            dt_employees = tb_employees.DataTable(tbOptions);
        });
    </script>
