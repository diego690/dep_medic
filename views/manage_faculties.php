...
<head>
    ...
    <title><?= ADMIN_PANEL_NAME ?> - Ver Facultades</title>
...
<body data-theme="colored" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="<?= SIDEBAR_TYPE ?>">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Ver Facultades</h1>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="tb_faculties" class="table table-striped table-hover table-bordered table-sm">
                                        <!-- table-sm -->
                                        <thead>
                                            <tr>
                                                <th>Nombre</th>
    ...
    <?php
    include_once("modals/faculties.php");
    include_once("includes/scripts.php");
    ?>

    <script>
        var dt_faculties = null;
        ...
        $(document).ready(function() {
            ...
            var tb_faculties = $('#tb_faculties');
            dt_faculties = tb_faculties.DataTable(tbOptions);
        });
    </script>
